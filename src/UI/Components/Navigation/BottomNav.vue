<template>
    <div :class="[
      ...
      <router-link to="/products">
        <Typography variant="h3" font="scholar" theme="gold">Produits</Typography>
      </router-link>
...
>
  <Typography variant="h3" font="scholar" theme="gold">Favoris</Typography>
</router-link>

      <div class="w-[1px] h-[85%] bg-gold"></div>
      <router-link to="/outfit-gallery">
        <Typography variant="h3" font="scholar" theme="gold">Galerie D'outfit</Typography>
      </router-link>
      <div class="w-[1px] h-[85%] bg-gold"></div>
      <router-link
  to="/cart"
...
>
  <Typography variant="h3" font="scholar" theme="gold">Panier</Typography>
</router-link>
      <div class="w-[1px] h-[85%] bg-gold"></div>
      <router-link v-if="isLoggedIn" to="/account" class="text-gold ">
      <Typography variant="h3" font="scholar" theme="gold">Compte</Typography>
    </router-link>

    <router-link v-else to="/log-in" class="text-gold ">
      <Typography variant="h3" font="scholar" theme="gold">Log-in</Typography>
    </router-link>
    </div>
  </template>
