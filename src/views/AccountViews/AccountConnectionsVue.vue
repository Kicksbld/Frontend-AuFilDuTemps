        ...
        <div class="mb-6 ">
          ...
          <div class="flex items-center gap-4 justify-between">
            <div v-if="editMode.sexe">
              <input type="text" v-model="edited.sexe" placeholder="Entrez votre sexe"
        ...
        <div class="mb-6">
          ...
          <div class="flex items-center gap-4 justify-between">
            <div v-if="editMode.taille">
              <input type="text" v-model="edited.taille" placeholder="Entrez votre taille"
                class="mt-1 text-scholar linear-bg block px-4 py-3 border-2 focus:bg-primary border-gold rounded-md bg-primary text-[#756048] focus:outline-none" />
            </div>
            <div v-else>
      ...
      <div class="mb-6 flex-1">
        ...
        <div class="flex items-center gap-4 justify-between">
          <div v-if="editMode.couleurs">
            <input type="text" v-model="edited.couleurs" placeholder="Entrez votre couleur favorite"
              class="mt-1 text-scholar linear-bg block px-4 py-3 border-2 focus:bg-primary border-gold rounded-md bg-primary text-[#756048] focus:outline-none" />
          </div>
          <div v-else>
